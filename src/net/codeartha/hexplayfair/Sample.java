...
public class Sample {
	...
	public static void main(String[] args) {
		HexPlayfair pf = new HexPlayfair(); // create new Playfair object
		...
		pf.setMsgIn("atopsecretmessageyouwanttoencrypt"); // type in your
															// message
		pf.encryptMsg(); // encrypting it
		System.out.println(pf.getMsgOut());
		pf.clearMsgIn(); // good practice to clear msgIn before setting a new
